...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input(f"\nPlease enter the number for the {menu_category_name} item you would like to order: ")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    order.append({'Item Name':food_item, 'Price':item_price, 'Quantity': quantity})
                    # Tell the customer that their input isn't valid
                else:
                    print("You input isn't valid!")
...
for ordered in order:
    ...
    item_name, price, quantity = ordered['Item Name'], ordered['Price'], ordered['Quantity']

    # 8. Calculate the number of spaces for formatted printing

    item_space_str_len = 26 - len(item_name)
    price_space_str_len = 7 - len(str(price))
